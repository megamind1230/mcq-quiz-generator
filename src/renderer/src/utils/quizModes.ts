...
export function isInstantMode(mode: QuizMode): boolean {
  return mode === 'loop' || mode === 'instant'
}

export function exactMatch(q: { selectedIndices?: number[]; correctIndices: number[] }): boolean {
